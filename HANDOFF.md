...
- **Hallazgo 6 decidido, no construido**: Miguel eligió la **opción B** (18 Sep 2026) — el P&L en comisión pura muestra la venta bruta y una línea "Remitido al productor", con la utilidad bruta igual a la comisión; más un renglón "Ingreso propio (comisión)" para el contador. Es el siguiente bloque natural.
