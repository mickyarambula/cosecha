...
- **Contestado por Miguel el 23 Sep 2026:** **todos los depósitos de JEAMS en Chase son préstamo** — ninguno es capital. Unos no tienen costo y otros sí: los del back to back (6.2 %). **No se ha recuperado nada** de Akambarhu, Santana ni Cornejos: están en siembra, la recuperación empieza en noviembre/diciembre con la producción. Para el corte, lo pendiente de cada productor al 30 Sep es todo lo pagado. **Todo lo depositado desde julio es back to back (6.2 %)**, incluidos los de semilla y los de $15,000 y $35,000 (Miguel, 23 Sep 2026); lo de enero a junio es préstamo sin costo.
- **Balance de apertura completo, vista previa al 30 Sep con datos del 22 Sep** (`gen-corte.py`): activo — CxC $589,899.58, Chase $17,855.12, financiamiento a productores $261,879.07 (Akambarhu $130,080.32 · Santana $108,790.55 · Cornejos $16,690.20 · sin asignar $6,318); pasivo — CxP $512,972.59, JEAMS sin costo $157,014.33 (los $52,447.33 que pagó directo en enero + $104,567 de depósitos ene–jun), JEAMS back to back $253,526; capital −$53,879.15. El back to back ($253,526) casi iguala a lo financiado: es el dinero de JEAMS pasando a los productores. El proceso trata como financiamiento todo lo que en Chase es "Prestamo", aunque en Egresos esté como costo (folio 422, semilla de Cornejos, $8,307.60; y dos fletes de semilla de Aruba). **Pendiente de Miguel:** partir el folio 386 ($6,318 a Samuel, "Akambarhu y NGM247514") entre financiamiento a Akambarhu y gasto de la carga.
